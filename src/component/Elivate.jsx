...
// export default function Elivate() {
//   return (
//     <div className="flex mt-32">
//       <div className=" w-2/3 px-20 py-6 mt-12">
//         <div className="mb-6">
...
//             Partner with us and unlock your company&#39;s potential for growth and
//             success.
//           </p>
//         </div>

//         <div className="flex flex-col md:flex-row  gap-4">
//                <button className="border border-gray-800 font-semibold py-4 text-[18px] px-4 rounded-lg focus:outline-none">
//                 Enter Your Email Address
//               </button>
//               <button className="bg-[#EF2AB2] font-semibold text-white text-[18px] py-4 px-6 rounded-lg focus:outline-none">
//              Get Started Today
//             </button>
//           </div>
