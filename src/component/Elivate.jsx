    ...
    <div className="flex mt-32">
      <div className=" w-1/2 px-32 ">
        ...
        <div className="flex flex-col md:flex-row gap-4 ">
          <button className="px-12 py-2 rounded-xl border-2 border-gray-800  transition-colors hover:bg-[#D9236E]">
        ...
        <div className=" flex gap-10">
          <div className="flex flex-col ">
            <h2 className="text-4xl font-semibold text-[#172755]">2.5k+</h2>
...
<div className="flex  ">
            <div>
              <h2 className="text-4xl font-semibold text-[#172755]">5.0</h2>
            </div>
